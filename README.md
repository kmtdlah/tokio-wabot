...
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/N17R0-HACKERS/tokio-wabot)
...
git clone https://github.com/N17R0-HACKERS/tokio-wabot
cd tokio-wabot
npm install
npm update
```
